...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center bg-[#FFD700] text-gray-800 shadow-md px-4">  
      ...
      <ul className="hidden md:flex space-x-4">
        ...
        {/* Mobile View */}
        <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 h-screen w-full bg-[#FFD700] text-white items-center flex flex-col justify-center'}>
